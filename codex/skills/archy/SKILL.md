...
description: >
  ...
  into a PRD before Chisel creates issues. Triggers: use the `archy` skill
  after Forge produces complexity: high. Do NOT trigger on low or medium
  complexity outputs from Forge.
---
